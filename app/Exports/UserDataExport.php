...
class UserDataExport implements FromCollection, WithHeadings, WithEvents,WithTitle,WithStrictNullComparison
{
    ...
    {       
        ...
        return User::select('id','login_type','name','email','phone','is_verified','imageurl','state_id','district_id','taluka_id','pincode_id','gst_number','is_disable')->where('login_type','!=',1)->get();
    }
