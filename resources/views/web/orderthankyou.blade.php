    ...
    @endif
            ...
            <div class="d-flex align-items-center justify-content-center gap-10">
             <div class="product__variant--list mb-30">
                <a href="{{ url('/webhome') }}"><button class="variant__buy--now__btn primary__btn" id="gocheckout" type="submit">Explore
                     us</button> </a>
             </div>
             <div class="product__variant--list mb-30">
                  <a href="{{url('myorder')}}"><button class="variant__buy--now__btn primary__btn pink-color" id="" type="submit">My
                  Request</button> </a>
             </div>
         </div>
        </div>
