          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="col-md-5 col-xs-12">
                <h3 class="card-title">Edit Gallary</h3>
              </div>
            ...
            @endif
              <input type="hidden" name="id" id="id" value="{{$gallaryData->gallary_id}}">   
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <div class="fileupload_block">
                        ...
                        @if(isset($gallaryData) && isset($gallaryData->imageurl))
                              @if($gallaryData->imageurl !='')
                            <div class="fileupload_img"><img type="image" src="{{$gallaryData->imageurl}}" style="height: 80px;width: 80px;margin-left: 20px;"  /></div>
                            @else
                            <div class="fileupload_img"><img type="image" src="{{asset('admin_assets/images/add-image.png')}}" /></div>
                            @endif
                          @endif
