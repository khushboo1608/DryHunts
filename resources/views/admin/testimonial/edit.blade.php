      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            @endif
              <input type="hidden" name="id" id="id" value="{{$testimonialData->testimonial_id}}">   
                <div class="card-body">
                <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <div class="fileupload_block">
                            ...
                            <input name="testimonial_image"  type="file" value="{{$testimonialData->testimonial_image}}" id="testimonial_image" accept="image/png, image/jpeg, image/jpg" >
                                @if(isset($testimonialData) && isset($testimonialData->testimonial_image))
                                @if($testimonialData->testimonial_image !='')
                            <div class="fileupload_img"><img type="image" src="{{$testimonialData->testimonial_image}}" style="width: 100px;height: 100px;"/></div>
                            @else
                            <div class="fileupload_img"><img type="image" src="{{config('global.no_image.add_image');}}" /></div>
                            @endif
                          @endif
                          <input id="testimonial_image" type="hidden" name="testimonial_image_edit"  value="{{$testimonialData->testimonial_image ?  $testimonialData->testimonial_image:''}}" required="true">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input id="testimonial_title" name="testimonial_title" type="text" class="form-control" required="true"  placeholder="Enter Testimonial Title" value="{{$testimonialData->testimonial_title}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        ...
                        <textarea name="testimonial_description" id="testimonial_description" class="form-control">{{ isset($testimonialData->testimonial_description) ? $testimonialData->testimonial_description : '' }}</textarea>
                      ...
                      <option selected="true" disabled="disabled">Choose Category </option>
                          ...
                          @if(isset($master_data) && isset($master_data['category']))
                                @foreach ($master_data['category'] as $item)
                                        <option value="{{ $item['category_id'] }}" {{ ( $item['category_id'] == $testimonialData['category_id']) ? 'selected' : '' }}> {{$item['category_name']}} </option>
                                    @endforeach
                                @endif
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        ...
                        <option value="0">--Select Service--</option>
                            ...
                            @foreach($master_data['service'] as $list)
                                @if( $testimonialData['service_id']==$list['service_id'])
                                    <option selected value="{{$list['service_id']}}">{{$list['service_name']}}</option>
                                @else
                        ...
                        <select name="state_id"  id="state_id" class="form-control select2 filter" >
                          <option selected="true" disabled="disabled">Choose State</option>
                                ...
                                @foreach ($master_data['state'] as $item)
                                        <option value="{{ $item['state_id'] }}" {{ ( $item['state_id'] == $testimonialData['state_id']) ? 'selected' : '' }}> {{$item['state_name']}} </option>
                                    @endforeach
                                @endif
                        </select>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <option value="0">--Select District--</option>
                                      @foreach($master_data['district'] as $list)
                                          @if( $testimonialData['district_id']==$list['district_id'])
                      ...
                      <div class="col-md-6">
                        ...
                        <option value="0">--Select Taluka--</option>
                                      @foreach($master_data['taluka'] as $list)
                                          @if( $testimonialData['taluka_id']==$list['taluka_id'])
                      ...
                      <div class="col-md-6">
                        ...
                        <option value="0">--Select Pincode--</option>
                                      @foreach($master_data['pincode'] as $list)
                                          @if( $testimonialData['pincode_id']==$list['pincode_id'])
