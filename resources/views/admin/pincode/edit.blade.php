      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            @endif
              <input type="hidden" name="id" id="id" value="{{$pincodeData->pincode_id}}">   
                <div class="card-body">
                <div class="form-group row">
                        ...
                        <select name="state_id"  id="state_id" class="form-control select2 filter" >
                          <option selected="true" disabled="disabled">Choose State</option>
                                ...
                                @foreach ($master_data['state'] as $item)
                                        <option value="{{ $item['state_id'] }}" {{ ( $item['state_id'] == $pincodeData['state_id']) ? 'selected' : '' }}> {{$item['state_name']}} </option>
                                    @endforeach
                                @endif
                        </select>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <option value="0">--Select District--</option>
                                      @foreach($master_data['district'] as $list)
                                          @if( $pincodeData['district_id']==$list['district_id'])
                      ...
                      <div class="col-md-6">
                        ...
                        <option value="0">--Select Taluka--</option>
                                      @foreach($master_data['taluka'] as $list)
                                          @if( $pincodeData['taluka_id']==$list['taluka_id'])
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="pincode" name="pincode" placeholder="Pincode Name" required="true" value="{{$pincodeData->pincode}}">
                    </div>
                  </div>                  
