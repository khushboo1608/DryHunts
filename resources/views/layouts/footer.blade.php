...
<footer class="footer__section footer__bg">
    <div class="container-fluid">
        <div class="main__footer">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget logo-data">
                        <div class="footer__widget--inner">
                            <a class="footer__logo" href="@if (Auth::check()) {{url('webhome')}} @else  @endif"><img src="{{ url('assets/img/logo/nav-log.webp') }}" alt="footer-logo"></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        ...
                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('/')}}">Home</a></li>
                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('testimonialList') }}">Testimonial</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('aboutus') }}">About Us</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('contactus') }}">Contact Us</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('privacypolicy') }}">Privacy Policy</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                        @if (Auth::check())
                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('userProfile')}}">My Account</a></li>
                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('cart')}}">Shopping Cart</a></li>

                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" ref="#"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();" >Log out</a></li>
                    ...
                    @csrf
                        ...
                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('userlogin')}}">Login</a></li>
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-center">
            <p class="copyright__content  m-0">Copyright © 2023 <a class="copyright__content--link" href="index.html">Dryhunt</a> . All Rights Reserved.Design By Dryhunt</p>
            <div class="footer__payment text-right">
                <img class="footer__payment--visa__card display-block" src="https://drapo.in/assets/img/other/payment-visa-card.webp" alt="visa-card">
            </div>
        </div>
    </div>
</footer>   